...
const pageModule = document.body.dataset.conversationModule || 'all';
const initialQuery = document.body.dataset.initialQuery || 'How do I order bubble tea?';
const state = { module: pageModule };
...
moduleButtons.forEach((button) => {
  button.classList.toggle('active', button.dataset.module === pageModule);
});
